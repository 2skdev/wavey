...
class _$_PostState implements _PostState {
  const _$_PostState(
      ...
      this.trackId = '',
      @GeoPointConverter() this.latlng = const GeoPoint(0, 0)});
  ...
  @override
  String toString() {
    return 'PostState(id: $id, trackId: $trackId, latlng: $latlng)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, trackId, latlng);
...
abstract class _PostState implements PostState {
  const factory _PostState(
      ...
      final String trackId,
      @GeoPointConverter() final GeoPoint latlng}) = _$_PostState;
